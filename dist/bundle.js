...
var hentliste = document.getElementById("list_highscore");
// Buttonhent.addEventListener("click", MouseEvent => {
_node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get('https://highscore20181022124259.azurewebsites.net/api/Highscore')
    .then(function (response) {
    // handle success
    var hs = response.data;
    hs.forEach(function (scores) {
